...
3. [元组](#元组)<br>
   [1. 创建和访问一个元组](#创建和访问一个元组)<br>
   [2. 更新和删除一个元组](#更新和删除一个元组)<br>
   [3. 元组相关的操作符](#元组相关的操作符)<br>
   [4. 内置方法](#内置方法)<br>
   [5. 解压元组](#解压元组)<br>
   
4. [字符串](#字符串)<br>
   [1. 字符串的定义](#字符串的定义)<br>
   [2. 字符串的切片与拼接](#字符串的切片与拼接)<br>
   [3. 字符串的常用内置方法](#字符串的常用内置方法)<br>
   [4. 字符串格式化](#字符串格式化)<br>
   
5. [字典](#字典)<br>
   [1. 可变类型与不可变类型](#可变类型与不可变类型)<br>
   [2. 字典的定义](#字典的定义)<br>
   [3. 创建和访问字典](#创建和访问字典)<br>
   [4. 字典的内置方法](#字典的内置方法)<br>
   
6. [集合](#集合)<br>
   [1. 集合的创建](#集合的创建)<br>
   [2. 访问集合中的值](#访问集合中的值)<br>
   [3. 集合的内置方法](#集合的内置方法)<br>
   [4. 集合的转换](#集合的转换)<br>
   [5. 不可变集合](#不可变集合)<br>
   
7. [序列](#序列)<br>
   [1. 针对序列的内置函数](#针对序列的内置函数)<br>
